namespace TinyTeam.UI
{
    ...
    public class TTUIRoot : MonoBehaviour
    {
        ...
        static void Init()
        {
            GameObject g = Instantiate(Resources.Load("UIRoot/UIRoot")) as GameObject;
            g.transform.localPosition = Vector3.zero;
            g.name = "UIRoot";
            m_Instance = g.GetComponent<TTUIRoot>();
        }
        ...
        static void InitRoot()
        {
            ...
            GameObject roleRoot = new GameObject("RoleRoot");
            roleRoot.layer = LayerMask.NameToLayer("RoleModel");
            roleRoot.transform.SetParent(go.transform);
